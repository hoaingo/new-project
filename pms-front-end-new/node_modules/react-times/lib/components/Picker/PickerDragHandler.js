...
var PickerDragHandler = function (_React$PureComponent) {
  ...
  _createClass(PickerDragHandler, [{
    ...
    value: function resetOrigin() {
      ...
      this.originX = centerPointPos.left + centerPoint.clientWidth / 2 + Math.max(document.documentElement.scrollLeft, document.body.scrollLeft);
      this.originY = centerPointPos.top + centerPoint.clientHeight / 2 + Math.max(document.documentElement.scrollTop, document.body.scrollTop);
